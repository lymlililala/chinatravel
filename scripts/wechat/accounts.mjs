...
const ACCOUNT_NAMES = [
  ...
  // ── 美食深度（本站美食文偏薄，补在地饮食/风味）──
  '三联美食', '企鹅吃喝指南', '风味星球', '福桃九分饱',
  // ── 户外/徒步/自驾（玩法维度，户外/自驾内容稀缺）──
  '户外探险outdoor', '中国自驾地理', '徒步中国', '8264户外',
  // ── 文博/历史/非遗（深度人文，世界遗产/古建/博物馆选题）──
  '国家人文历史', '博物馆丨看展览', '意外艺术', '动脉影',
  // ── 民宿/在地生活（民宿/慢旅选题）──
  '大乐之野', '借宿', '隐居乡里',
  // ── 人文地理/深度旅行（高质量长文）──
  '九行Travel', '地球旅客', '中国国家地理BOOK',
  // ── 小众/生活方式旅行（discover.mjs 命中多关键词的内容号）──
  'Feekr旅行'
]
