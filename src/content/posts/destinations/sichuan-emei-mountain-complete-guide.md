...
### Quick Route (2 days)
**Day 1:** Bus to Leidongping car park; cable car to Golden Summit (¥65 one way); evening in summit guesthouse.
**Day 2:** Sunrise; descend via cable car and bus.
*Total hiking: minimal; suited to visitors primarily interested in the summit views.*

### Classic Route (3–4 days)
**Day 1:** Baoguo Temple → Qingyin Pavilion → Wannian Temple (bus shortcut available). Stay at Wannian Temple guesthouse.
**Day 2:** Wannian Temple → Xianfeng Temple → Leidongping via stone path.
**Day 3:** Leidongping → Golden Summit (cable car); morning at summit.
**Day 4:** Descend to Leidongping; bus down.
...
**Comprehensive Ticket:** ¥160 peak season (April–October), ¥110 off-season.
**Cable Car (Jinding):** ¥65 one way, ¥100 return.
**Monastery guesthouses:** ¥60–¥150/night; basic accommodation with canteen food.
