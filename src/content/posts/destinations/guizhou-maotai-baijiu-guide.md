...
title: "Maotai Town Guizhou Guide 2026: China's Famous Baijiu Distillery & Spirits Tourism"
featured: false
draft: false
tags:
  - maotai
...
1. **Observe the colour:** Hold the glass against a white background. Maotai should be clear and colourless, with a slight viscous quality
2. **Smell in stages:** First smell from a distance, then bring the glass closer. Maotai's aroma should unfold in layers — soy sauce, flowers, fruit, nuts, and a characteristic fermented note that devotees call "the Maotai smell"
3. **Sip, don't shoot:** Take a small sip and let it coat your tongue. Maotai is 53% ABV, so it will burn — but behind the initial heat, you should taste the complexity
4. **Appreciate the aftertaste (huí wèi, 回味):** The hallmark of good sauce-aroma baijiu is a long, pleasant aftertaste that can linger for 30 minutes or more
5. **Drink water between sips:** This cleanses the palate and, according to tradition, enhances the aftertaste
