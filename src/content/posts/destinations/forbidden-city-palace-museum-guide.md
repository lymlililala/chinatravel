...
title: "Forbidden City (Palace Museum) Beijing: Complete Visitor's Guide"
featured: false
draft: false
tags:
  - beijing
...
**How to book:**
1. Visit **dpm.org.cn** (the official Palace Museum website) or use the WeChat/Alipay mini-programs
2. Register with your passport number
3. Select your visit date — book at least **2–3 weeks in advance** during peak season (April–October)
4. Pay online: ¥60 per adult (peak season), ¥40 (off-season November–March). Free for visitors under 18 and over 65.
5. Show the QR code at the Meridian Gate entrance — no printing required
