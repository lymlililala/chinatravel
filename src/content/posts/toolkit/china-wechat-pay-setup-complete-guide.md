...
**Scanning merchant QR code:**
Open WeChat → tap the "+" or "Scan" icon → scan the merchant's QR code → enter amount → confirm payment.

**Showing your QR code to be scanned:**
Open WeChat → tap "+" → "Money" → "Receive Money" → your payment QR code appears; the merchant scans it.
