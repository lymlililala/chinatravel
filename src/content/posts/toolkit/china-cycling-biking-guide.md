...
title: "Cycling in China 2025: Renting Bikes, Bike Share Apps & Best Routes for Visitors"
featured: false
draft: false
tags:
  - transport
...
**Unlock process:**
1. Open the app → tap "Scan" or "Unlock Bike"
2. Scan the QR code on the bike's handlebars
3. The lock clicks open
4. Ride, then park in any designated parking zone (marked on the map)
5. Lock manually or via app to end the trip
