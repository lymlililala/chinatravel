...
title: "Chishui Guizhou Guide 2026: Danxia Red Rocks, Bamboo Sea & Waterfall Valley"
featured: false
draft: false
tags:
  - guizhou
...
Chishui (赤水) doesn't come up in most Guizhou itineraries, which is a shame because it's doing things with rocks and water that you won't see anywhere else. The city name literally means "Red Water" — a reference to the Chishui River that runs red with silt from the Danxia rock formations upstream. These formations are part of the China Danxia UNESCO World Heritage Site (inscribed in 2010), and the particular character of Chishui's red rock — layered, eroded, cliff-forming — creates landscapes that feel genuinely alien.
