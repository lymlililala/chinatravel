...
**Getting there:** High-speed train from Taiyuan (30 min); from Beijing, train to Taiyuan then connection (total 3–4 hours).
**Best time:** Spring (April–May) and autumn (October). Avoid July–August (hot and crowded) and major Chinese holidays.
**Day trip vs. overnight:** Day trips are possible from Taiyuan but miss the essential experience. Two nights minimum recommended.
